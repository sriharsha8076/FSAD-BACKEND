  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.certificateFile) {
        ...
        const uploadResponse = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8080'}/api/achievements/upload`, {
          method: 'POST',
          headers: {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8080'}/api/achievements`, {
        method: 'POST',
        headers: {
